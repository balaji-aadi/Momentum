/**
 * InputSpecification - Canonical Single Source of Truth for Problem Inputs
 * Separates Structural Topology from Validation Rules.
 */
...
export class InputSpecification {
  constructor({
    ...
    this.structuralSpec = {
      category: structuralSpec.category || 'PRIMITIVE', // PRIMITIVE, ARRAY, MATRIX, TREE, GRAPH, LIST, GRAMMAR, CUSTOM
